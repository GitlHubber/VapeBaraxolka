...
import ragalik.baraxolka.view.ui.image_menu.EditCreatorImageMenu;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class EditCreatorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createCategorySpinner(String category, String subcategory) {
        ...
        ApiClient.getApi().getCategoriesWithSubcategories().enqueue(new Callback<CategoryResponse>() {
            ...
            public void onFailure(Call<CategoryResponse> call, Throwable t) {
                Toast.makeText(EditCreatorActivity.this, "Проверьте интернет соединение.", Toast.LENGTH_SHORT).show();
            }
        });
    }
