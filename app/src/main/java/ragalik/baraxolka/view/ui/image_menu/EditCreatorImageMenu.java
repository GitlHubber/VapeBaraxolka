...
import static ragalik.baraxolka.view.ui.activity.EditCreatorActivity.adImages;
import static ragalik.baraxolka.view.ui.activity.EditCreatorActivity.fileWithUri;
import static ragalik.baraxolka.view.ui.activity.EditCreatorActivity.outputFileUri;
            ...
            public void onClick(View view) {
                ...
                if (chooseIndex <= imageUploadCount) {
                    for (int i = chooseIndex; i < imageUploadCount - 1; ++i) {
                        ...
                        EditCreatorActivity.uris.set(i, EditCreatorActivity.uris.get(i + 1));
                        EditCreatorActivity.files.set(i, EditCreatorActivity.files.get(i + 1));
                    }

                    EditCreatorActivity.uris.remove(imageUploadCount - 1);
                    EditCreatorActivity.files.remove(imageUploadCount - 1);
                    ...
                    imageUploadCount--;
                    EditCreatorActivity.imageUploadCount--;
                    ...
                    if (imageUploadCount != 0) {
                        ...
                        adImages.get(imageUploadCount).setImageDrawable(getResources().getDrawable(R.drawable.ic_circle_add));
                        EditCreatorActivity.mainLabel.setVisibility(View.GONE);
                    }

                    EditCreatorActivity.uploadedCounterStr = EditCreatorActivity.uploadedCounterStr.substring(0, 10) + imageUploadCount + EditCreatorActivity.uploadedCounterStr.substring(11, 16);
                    EditCreatorActivity.uploadAmountTW.setText(EditCreatorActivity.uploadedCounterStr);
